    ...
    <View>
      <XStack className="gap-2">
        ...
        {assistant.model && assistant.enableWebSearch && (
          <XStack className="gap-1 rounded-xl py-1 px-2 border-[0.5px] border-green-20 dark:border-green-dark-20 bg-green-10 dark:bg-green-dark-10 justify-between items-center">
